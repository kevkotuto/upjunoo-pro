...
import { articles, getArticleBySlug, getArticleById } from "@/data/articles";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-primary font-semibold">A lire aussi</span>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Decouvrez toutes nos actualites et restez informe des dernieres
              nouveautes UPJUNOO PRO.
            </p>
            <Link href="/actualites">
