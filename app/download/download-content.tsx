  ...
  const apps = [
    {
      ...
      icon: Smartphone,
      features: [
        t("downloadApp.apps.rider.features.taxi"),
        t("downloadApp.apps.rider.features.delivery"),
        t("downloadApp.apps.rider.features.rental"),
      ],
    ...
    },
    {
      ...
      icon: Car,
      features: [
        t("downloadApp.apps.driver.features.rides"),
        t("downloadApp.apps.driver.features.earnings"),
        t("downloadApp.apps.driver.features.dashboard"),
      ],
